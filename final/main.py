...
class Game :
    def __init__(self):
        ...
        self.intro = pygame.transform.scale(pygame.image.load("img/intro/00.png"), (WIN_WIDTH, WIN_HEIGHT))
        self.test = pygame.transform.scale(pygame.image.load("img/intro/tortus.jpg"), (WIN_WIDTH, WIN_HEIGHT))

        self.intro_music = r'music/street.mp3'#音樂測試
    ...
    def intro_screen_and_game_run(self):
        self.restart = False
        in_intro = True
...
while game.restart:
    game = Game()
    game.intro_screen_and_game_run()
