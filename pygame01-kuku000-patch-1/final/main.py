                ...
                if event.type == pygame.KEYDOWN:
                    ...
                    if event.key == pygame.K_SPACE:
                        if part_counter == 3:
                            ...
                            if part_counter == 0:
                                self.screen.blit(self.entry, (0, 0))
                                self.screen.blit(short_intro_text1_image, (100, 100))
                            if part_counter == 1:
                                self.screen.blit(self.entry, (0, 0))
                                self.screen.blit(short_intro_text1_image, (100, 200))
                            if part_counter == 2:
                                self.screen.blit(self.entry, (0, 0))
                                self.screen.blit(short_intro_text1_image, (100, 300))
                            if part_counter == 3:
                                self.screen.blit(self.entry, (0, 0))
                                self.screen.blit(short_intro_text1_image, (100, 400))
                            part_counter+=1
            self.clock.tick(FPS)
            pygame.display.update()
